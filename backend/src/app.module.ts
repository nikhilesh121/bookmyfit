...
import { AmenityEntity, CategoryEntity, WorkoutVideoEntity } from './database/entities/misc.entity';
...
@Module({
  ...
  imports: [
    TypeOrmModule.forFeature([UserEntity, GymEntity, MultiGymNetworkEntity, ProductEntity, CorporateAccountEntity, WorkoutVideoEntity, CategoryEntity, AmenityEntity, GymSlotEntity, SlotBookingEntity, AppConfigEntity, GymScheduleEntity, SessionTypeEntity, SessionScheduleEntity, SessionSlotEntity, SessionBookingEntity, AttendanceEntity, WellnessPartnerEntity, WellnessServiceEntity]),
