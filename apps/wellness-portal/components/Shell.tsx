...
import { LayoutDashboard, Dumbbell, Calendar, User, LogOut, DollarSign, MessageSquareText } from 'lucide-react';
    ...
    <div className="flex min-h-screen text-white">
      <aside className="w-64 border-r flex flex-col" style={{ borderColor: 'rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)' }}>
        <div className="p-5 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="kicker mt-1" style={{ color: 'var(--accent)', opacity: 0.7 }}>Wellness Partner</div>
        </div>
        ...
        <div className="p-3 border-t" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
          <button
            onClick={logout}
            className="flex items-center gap-2 text-[12px] w-full px-3 py-2 rounded-lg transition"
