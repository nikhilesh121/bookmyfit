...
const s = StyleSheet.create({
  ...
  partnerImgWrapper: { width: 122, alignSelf: 'stretch', position: 'relative', backgroundColor: colors.surface },
  partnerImg: { width: 122, flex: 1, resizeMode: 'cover', backgroundColor: colors.surface },
  discountBadge: {
  ...
  partnerInfo: { flex: 1, minWidth: 0, paddingHorizontal: 12, paddingVertical: 10, gap: 5, justifyContent: 'space-between' },
  ...
  viewRow: { flexDirection: 'row', justifyContent: 'flex-start', marginTop: 2, flexShrink: 0 },
  viewBtn: {
