...
const FALLBACK = {
  ...
  growthPercent: 18,
  breakdown: [
    { label: 'Elite Subscriptions', subLabel: '132 members', amount: 119800, color: colors.accent, aurora: 'rgba(204,255,0,0.1)' },
...
const s = StyleSheet.create({
  ...
  netCard: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    marginTop: 12,
    backgroundColor: 'rgba(204,255,0,0.06)', borderWidth: 1, borderColor: 'rgba(204,255,0,0.2)',
