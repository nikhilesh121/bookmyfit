...
export default function TrainersScreen() {
  ...
  const handleBook = async () => {
    ...
    setBooking(true);
    try {
      await trainersApi.book(selected.id, {
        userId: user.id,
      ...
      setSelected(null);
      Alert.alert('Booked!', `Your session with ${selected.name} has been booked. They will contact you shortly.`);
    } catch (err: any) {
...
const s = StyleSheet.create({
  ...
  aurora: {
    ...
    borderRadius: 150, backgroundColor: 'rgba(204,255,0,0.08)',
  },
  header: {
  ...
  avatar: {
    ...
    backgroundColor: 'rgba(204,255,0,0.1)', borderWidth: 1, borderColor: colors.accentBorder,
    alignItems: 'center', justifyContent: 'center',
  },
